...
```
![Total number of steps per day](fig1.png)
...
```
![Average steps per interval across all days](fig2.png)
...
```
![Total number of steps (imputed) per day](fig3.png)
...
print(finalPlot)
```
![Average number of steps per interval for weekday and weekend](fig4.png)
